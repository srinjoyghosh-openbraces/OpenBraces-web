...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col items-center gap-6 py-14 px-4
    sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white"
    >
      {/* <div
      ...
      <h1
        className="text-4xl sm:text-5xl md:text-5xl xl:text-[84px] font-medium
        xl:leading-[95px] max-w-5xl"
      >
        Turning business challenges into{" "}
        <span className="bg-gradient-to-r from-[#0792c9] to-[#216cdd] bg-clip-text text-transparent">
          digital
        </span>{" "}
        solutions.
      </h1>
