...
const Navbar = ({ theme, setTheme }) => {
  ...
  return (
    <div
      className="w-full flex justify-between items-center px-8 py-3 
  sm:px-12 lg:px-24 xl:px-40 sticky top-0 z-20 backdrop-blur-xl font-medium bg-white/50 dark:bg-gray-400/45"
    >
      <img
        src={theme === "dark" ? assets.logo1 : assets.logo1}
        className="w-36 sm:w-48 lg:w-57"
        alt=""
      />
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        items-center gap-2 bg-blue-500 text-white px-6 py-2
